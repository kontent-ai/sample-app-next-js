...
export const ArticleItem: FC<Props> = (props) => (
  <li className="m-0 p-0 w-full h-full relative md:rounded-lg shadow hover:shadow-xl transition-shadow border border-gray-200 cursor-pointer">
    <Link href={props.detailUrl} className="no-underline group h-full flex flex-col">
      ...
      <div className="p-5 grow">
        <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 no-underline line-clamp-1 ">
          {props.title}
        </h5>
      ...
      <button
        type="button"
        className="group-hover:bg-mainHoverColor bg-mainButtonColor block ml-auto w-fit mb-3 mr-4 font-semibold border text-white py-2 px-4 md:rounded"
      >
