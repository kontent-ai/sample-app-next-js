...
import type { Person } from "../../models/content-types/index.ts";
...
export const PersonHorizontal: FC<Props> = (props) => {
  ...
  return (
    <div className="flex items-center" {...createItemSmartLink(props.item.system.id)}>
      <figure
      ...
      <div className="flex flex-col pl-4">
        <span>
          <span {...createElementSmartLink(contentTypes.person.elements.first_name.codename, true)}>
            {props.item.elements.first_name.value}
          </span>
          &nbsp;
          <span {...createElementSmartLink(contentTypes.person.elements.last_name.codename, true)}>
            {props.item.elements.last_name.value}
          </span>
        </span>
        <em {...createElementSmartLink(contentTypes.person.elements.occupation.codename, true)}>
