import { isValidCollectionCodename } from "../types/perCollection.ts";
...
export const deliveryApiDomain = NEXT_PUBLIC_KONTENT_DOMAIN
  ? `https://deliver.${NEXT_PUBLIC_KONTENT_DOMAIN}`
  : NEXT_PUBLIC_KONTENT_DAPI_DOMAIN;

export const deliveryPreviewApiDomain = NEXT_PUBLIC_KONTENT_DOMAIN
  ? `https://preview-deliver.${NEXT_PUBLIC_KONTENT_DOMAIN}`
  : NEXT_PUBLIC_KONTENT_PREVIEW_DAPI_DOMAIN;

export const managementApiDomain = NEXT_PUBLIC_KONTENT_DOMAIN
  ? `https://manage.${NEXT_PUBLIC_KONTENT_DOMAIN}`
  : NEXT_PUBLIC_KONTENT_MAPI_DOMAIN;

export const internalApiDomain = NEXT_PUBLIC_KONTENT_DOMAIN
  ? `https://app.${NEXT_PUBLIC_KONTENT_DOMAIN}`
  : NEXT_PUBLIC_KONTENT_IAPI_DOMAIN;

export const authApiDomain = NEXT_PUBLIC_KONTENT_DOMAIN
  ? `login.${NEXT_PUBLIC_KONTENT_DOMAIN}`
